...
#define LPF_MODE_SINGLE_PWM_BRAKEFLOAT_FULL_LOOKAT \
  (B0000 << 12 | B0110 << 8 | B1111 << 4 |         \
   B0000)  // look at these bits to see if brake/float is pressed
#define LPF_MODE_SINGLE_PWM_BRAKEFLOAT_FULL_VALUES \
  (B0000 << 12 | B0100 << 8 | B1000 << 4 |         \
   B0000)  // check if bits have these values if brake/float i pressed

#define LPF_MODE_SINGLE_OUTPUT_FULL_LOOKAT \
  (B0000 << 12 | B0101 << 8 | B0000 << 4 | B0000)
#define LPF_MODE_SINGLE_OUTPUT_FULL_VALUES \
  (B0000 << 12 | B0001 << 8 | B0000 << 4 | B0000)
